...
export default function PictureGallery({ pictures, addToCart, walletAddress }) {
/*
      ...
      {pictures.map((pic) => (
        <div key={pic.id} className="border rounded-2xl shadow-lg p-4 space-y-4">
          ...
          <div className="flex justify-center pt-2">
            {walletAddress && walletAddress.toLowerCase() === pic.creator?.toLowerCase() ? (
              <span className="text-green-600 font-semibold">You own this NFT</span>
            ) : (
              <button
